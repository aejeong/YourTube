...
function goFullScreen(){
    ...
    fullScrnBtn.addEventListener("click",exitFullScreens);
}
...
function getCurrentTime(){
    currentTime.innerHTML = formaDate(Math.floor(videoPlayer.currentTime));
}
...
function init() {
    ...
    playBtn.addEventListener("click",handlePlayClick);
    volumBtn.addEventListener("click", handleVoulumeClick);
    fullScrnBtn.addEventListener("click",goFullScreen);
